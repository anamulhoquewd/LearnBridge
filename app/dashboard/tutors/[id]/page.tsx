            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <p className="text-sm leading-relaxed text-muted-foreground">
                  ...
                  hundreds of students achieve their academic goals and develop
                  a genuine love for learning. My teaching philosophy centers on
                  personalized instruction, patience, and making complex
                  concepts accessible and engaging.
                </p>
                <p className="text-sm leading-relaxed text-muted-foreground">
                  I specialize in mathematics and physics, working with students
                  from high school through college level. Whether you&apos;re
                  struggling with fundamental concepts or aiming for advanced
                  proficiency, I tailor my approach to your specific learning
                  style and goals.
                </p>
              </CardContent>
            </Card>
                ...
                <ul className="space-y-3">
                  ...
                  <li className="flex gap-3">
                    ...
                    <div>
                      ...
                      <p className="mt-1 text-xs text-muted-foreground">
                        Sessions available throughout the week, with options for
